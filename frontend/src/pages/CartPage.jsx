          ...
          <>
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center gap-4">
              <input
                ...
                className="w-full sm:flex-1 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 outline-indigo-500  text-sm"
              />
              <button
                className="w-full sm:w-auto px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-200 text-sm font-medium cursor-pointer"
                onClick={() => toast.success("Discount code applied!")}>
                Apply
              </button>
            </div>
